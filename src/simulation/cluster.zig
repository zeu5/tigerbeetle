...
const GridChecker = @import("grid_checker.zig").GridChecker;
const StateCheckerType = @import("state_checker.zig").StateCheckerType;
const ManifestCheckerType = @import("manifest_checker.zig").ManifestCheckerType;
const JournalCheckerType = @import("journal_checker.zig").JournalCheckerType;
    ...
    return struct {
        ...
        pub fn init(allocator: mem.Allocator, options: Options) !*Cluster {
            ...
            for (storages, 0..) |*storage, replica_index| {
                ...
                storage_options.fault_atlas = null;
